...
- **FR-028**: Undocumented env vars: AUTH_TYPE, CALENDARTOOL, CONFIGTOOL, ENTITIESTOOL, EUNOMIA_POLICY_FILE, EUNOMIA_TYPE, EVENTSTOOL, HISTORYTOOL, TLS_PROFILE, HOME_ASSISTANT_TOKEN
- **FR-029**: 3 Python env vars not in .env.example: TLS_PROFILE, HOME_ASSISTANT_TOKEN, HOME_ASSISTANT_URL
