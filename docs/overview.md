# home-assistant-agent — Concept Overview

> **Category**: Smart Home | **Ecosystem Role**: MCP Server + A2A Agent
...
├── home_assistant_agent/        # Source code
│   ├── __init__.py
...
```json
{
  "mcpServers": {
    "home-assistant-agent": {
      "command": "uv",
      "args": ["run", "--with", "home-assistant-agent", "home-mcp"],
      "env": {}
    }
  }
}
...
```bash
home-mcp --transport streamable-http --port 8001
```
